//
//  PTSegmentedControlViewController.m
//  PTKit
//
...
@implementation PTSegmentedControlViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.title = @"PTSegmentedControl Demo";
    ...
    PTSegmentedControl *segmentedControl = [[PTSegmentedControl alloc] initWithSectionTitles:@[@"Trending", @"News", @"Library"]];
    ...
    PTSegmentedControl *segmentedControl1 = [[PTSegmentedControl alloc] initWithSectionTitles:@[@"One", @"Two", @"Three", @"Four", @"Five", @"Six", @"Seven", @"Eight"]];
    segmentedControl1.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleWidth;
    segmentedControl1.frame = CGRectMake(0, 60, viewWidth, 40);
    segmentedControl1.segmentEdgeInset = UIEdgeInsetsMake(0, 10, 0, 10);
    segmentedControl1.selectionStyle = PTSegmentedControlSelectionStyleFullWidthStripe;
    segmentedControl1.selectionIndicatorLocation = PTSegmentedControlSelectionIndicatorLocationDown;
    ...
    [segmentedControl1 setTitleFormatter:^NSAttributedString *(PTSegmentedControl *segmentedControl, NSString *title, NSUInteger index, BOOL selected) {
    ...
    segmentedControl2.selectionIndicatorLocation = PTSegmentedControlSelectionIndicatorLocationDown;
    segmentedControl2.selectionStyle = PTSegmentedControlSelectionStyleTextWidthStripe;
    ...
    PTSegmentedControl *segmentedControl3 = [[PTSegmentedControl alloc] initWithSectionTitles:@[@"One", @"Two", @"Three", @"4", @"Five"]];
    ...
    segmentedControl3.selectionStyle = PTSegmentedControlSelectionStyleBox;
    segmentedControl3.selectedSegmentIndex = PTSegmentedControlNoSegment;
    segmentedControl3.selectionIndicatorLocation = PTSegmentedControlSelectionIndicatorLocationDown;
    segmentedControl3.shouldAnimateUserSelection = NO;
    segmentedControl3.tag = 2;
    [self.view addSubview:segmentedControl3];
    
    // Tying up the segmented control to a scroll view
    self.segmentedControl4 = [[PTSegmentedControl alloc] initWithFrame:CGRectMake(0, 260, viewWidth, 50)];
    ...
    self.segmentedControl4.selectionStyle = PTSegmentedControlSelectionStyleBox;
    self.segmentedControl4.selectionIndicatorLocation = PTSegmentedControlSelectionIndicatorLocationUp;
...
- (void)segmentedControlChangedValue:(PTSegmentedControl *)segmentedControl {
